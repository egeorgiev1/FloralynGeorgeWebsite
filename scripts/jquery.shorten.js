        ...
        $(document).on({
            click: function() {
                ...
                if ($this.hasClass('less')) {
                    ...
                    $this.parent().prev().css("display", "inline"); // fix the inline-block bug, to ne e bug, no i vse pak e nezelan behaviour: https://github.com/jquery/jquery/issues/2071
                }
                return false;
            }
        }, '.morelink');
